...
<c:if test="${sessionScope.user != null}">
    <c:set var="username"
           value="${fn:substringBefore(user.email, '@')}" />
                                            <div class="delivery-detail">
                                                <h6>Hello,</h6>
                                                <h5>${fn:join(user.given_name,user.family_name) == " " ? username :fn:join(user.given_name, user.family_name) }</h5>
                                            </div>
</c:if>
                                        </div>
                    ...
                    <div class="product-box-3 h-100">
                        <div class="product-header">
                            <div class="product-image">
                                <a href="detail?id=${wish.car_id}">
                                    <img src="./assets/images/cake/product/2.png" class="img-fluid blur-up lazyload"
                                        alt="">
                                </a>
                                <form action="wishlist?action=delete&idwish=${wish.wish_list_id}" method="POST">
                        ...
                        <div class="product-footer">
                            <div class="product-detail">
                                ...
                                <a href="product-left-thumbnail.html">
                                    <h5 class="name">${wish.car.name}</h5>
                                </a>
                                
                                <h5 class="price">
                                    <span class="theme-color">${wish.car.price}</span>
                                    <del>$90.00</del>
                                </h5>
