...
<html lang="en">
    ...
    <body>
                            ...
                            <div class="breadscrumb-contain">
                                ...
                                <nav>
                                    <ol class="breadcrumb mb-0">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Trở thành nhà cung cấp</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="container-fluid-lg">
                    ...
                    <div class="col-xxl-7">
                        <div class="seller-title h-100 d-flex align-items-center">
                            <div>
                                <h2>Trở thành người bán cho ApexAutos...</h2>
                                <p>Bạn đam mê xe hơi và muốn mở rộng doanh nghiệp của mình? Tham gia nền tảng thương mại điện tử về xe hơi của chúng tôi như một cộng tác viên bán hàng và tiếp cận một lượng lớn khán giả yêu xe. Với nền tảng của chúng tôi, bạn có thể giới thiệu kho xe của mình, kết nối với những người mua tiềm năng, và tăng trưởng doanh số bán hàng.</p>

                                <p>Là một cộng tác viên bán hàng, bạn sẽ hưởng lợi từ các chiến dịch tiếp thị rộng rãi của chúng tôi, giao diện thân thiện với người dùng, và hệ thống thanh toán an toàn. Chúng tôi cung cấp một trải nghiệm bán hàng liền mạch, cho phép bạn tập trung vào việc bạn làm tốt nhất - bán xe.</p>

                                <b>Tham gia với chúng tôi ngay hôm nay và trở thành một phần của cộng đồng người bán xe thịnh vượng của chúng tôi. Cùng nhau, chúng ta có thể thúc đẩy thành công và cách mạng hóa trải nghiệm mua xe.</b>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="become-service section-b-space">
            <div class="container-fluid-lg">
                <div class="seller-title mb-5">
                    <h2>Tại sao lại lựa chọn ApexAutos...?</h2>
                </div>
                ...
                <div class="row">
                    <div class="col-xxl-3">
                        <div class="service-box">
                            ...
                            <div class="service-detail">
                                <h4>Chi phí thấp nhất</h4>
                                <p>Trên nền tảng của chúng tôi, bạn sẽ tiết kiệm được nhiều chi phí hơn so với các kênh bán hàng truyền thống. Chúng tôi cung cấp các gói dịch vụ với chi phí hợp lý, giúp bạn tối ưu hóa lợi nhuận từ việc bán xe.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xxl-3">
                        <div class="service-box">
                            ...
                            <div class="service-detail">
                                <h4>Tỷ lệ tăng trưởng cao</h4>
                                <p>Nền tảng của chúng tôi không ngừng phát triển với lượng người dùng tăng trưởng đều đặn. Bằng cách tham gia ApexAutos, bạn sẽ tiếp cận được nhiều khách hàng tiềm năng và tăng trưởng doanh số một cách nhanh chóng.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xxl-3">
                        <div class="service-box">
                            ...
                            <div class="service-detail">
                                <h4>Dịch vụ nhận xe tận nơi</h4>
                                <p>Chúng tôi cung cấp dịch vụ nhận xe tận nơi, giúp bạn tiết kiệm thời gian và công sức. Bạn chỉ cần tập trung vào việc bán xe, mọi việc vận chuyển đã có chúng tôi lo liệu.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xxl-3">
                        <div class="service-box">
                            ...
                            <div class="service-detail">
                                ...
                                <p>Nền tảng của chúng tôi được thiết kế để dễ sử dụng, giúp bạn dễ dàng quản lý và cập nhật danh sách xe của mình. Với giao diện thân thiện và hỗ trợ tận tình, bạn sẽ nhanh chóng làm quen và tận dụng tối đa các tính năng mà chúng tôi cung cấp.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="business-section section-b-space">
            <div class="container-fluid-lg">
                <div class="vendor-title mb-5">
                    <h5>Kinh doanh trên apexAutoCommerce thật dễ dàng</h5>
                </div>
                            ...
                            <div class="business-box">
                                <div>
                                    ...
                                    <div class="business-detail">
                                        <h4>Đăng sản phẩm của bạn và nhận hỗ trợ từ dịch vụ nhà cung cấp</h4>
                                        <p>Đăng ký doanh nghiệp của bạn miễn phí và tạo danh mục sản phẩm. Bán hàng dưới nhãn hiệu riêng của bạn hoặc bán nhãn hiệu hiện có. Hoàn thành tài liệu và danh mục sản phẩm một cách dễ dàng với mạng lưới Dịch vụ Chuyên nghiệp của chúng tôi.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xxl-4">
                            <div class="business-box">
                                <div>
                                    ...
                                    <div class="business-detail">
                                        <h4>Nhận đơn hàng và lên lịch nhận xe</h4>
                                        <p>Khi đã đăng sản phẩm, chúng sẽ có sẵn cho hàng triệu người dùng. Nhận đơn hàng và quản lý doanh nghiệp trực tuyến của bạn thông qua Bảng điều khiển Người bán .</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="business-box">
                                <div>
                                    ...
                                    <div class="business-detail">
                                        ...
                                        <p>Nhận thanh toán nhanh chóng và thuận tiện vào tài khoản của bạn sau khi hoàn thành đơn hàng. Mở rộng doanh nghiệp của bạn với các khoản vay lãi suất thấp và không cần tài sản thế chấp.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <section class="selling-section section-b-space">
            <div class="container-fluid-lg">
                <div class="vendor-title pb-2">
                    <h5>Bắt đầu Bán Hàng</h5>
                    <p>Thị trường apexAuto là nền tảng hàng đầu tại Ấn Độ cho việc bán hàng trực tuyến. Dù bạn là nhà sản xuất, nhà cung cấp hay nhà phân phối, chỉ cần bán sản phẩm của bạn trực tuyến trên Apex Automobile và trở thành một người chơi hàng đầu trong thương mại điện tử với đầu tư tối thiểu.
                        Với đội ngũ chuyên gia cung cấp các hội thảo, đào tạo, hỗ trợ người bán và cổng thông tin người bán tiện lợi, Apex Automobile tập trung vào việc giáo dục và trao quyền cho các người bán trên toàn Ấn Độ. Bán hàng trên ApexAutomobile.com là dễ dàng và hoàn toàn miễn phí. Tất cả những gì bạn cần là đăng ký, liệt kê danh mục sản phẩm của bạn và bắt đầu bán hàng.</p>
                </div>
                <form action="home?state=become" method="post">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <textarea name="sellerdesc" id="simplemde" class="form-control mt-3"style="font-size: 20px; font-family: inherit" placeholder="Cho chúng tôi vài lí do hợp lí..." rows="3"></textarea>
                        </div>
                        ...
                        <div class="col-12">
                            <input type="submit" class="button-83 mt-3" value="Gửi yêu cầu"></button>
                        </div>
                    </div>
                </form>
            </div>
        ...
        <c:if test="${message != null}"> 
            <script type="text/javascript"> toastr.success(`${message}`, 'Success', {timeOut: 1000});</script> 
        </c:if>
        <c:if test="${errorMessage != null}"> 
            <script type="text/javascript"> toastr.error(`${errorMessage}`, 'Error', {timeOut: 1000});</script> 
        </c:if>
