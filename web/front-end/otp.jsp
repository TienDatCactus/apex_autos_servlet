                                        ...
                                        <div class="location-box" style="background-color: #acacac;">
                                            <button class="btn location-button" data-bs-toggle="modal"
                                                ...
                                                <span class="locat-name"
                                                    style="text-decoration: line-through;color: #5e5e5e;">Your
                                                    Location</span>
                    ...
                    <div class="row">
                        <div class="col-xxl-6 col-xl-5 col-lg-6 d-lg-block d-none ms-auto">
                            <div class="image-contain">
                                <img src="${pageContext.request.contextPath}/front-end/assets/images/inner-page/otp.png" class="img-fluid" alt="">
                            </div>
                        </div>
...
<c:if test="${not empty errorMessageVerify}">
                                    ...
                                    <div class="footer-logo-contain">
                                        ...
                                        <ul class="address">
                                            <li>
                                                ...
                                                <a href="javascript:void(0)">Khu CÃ´ng Nghá» Cao HÃ²a Láº¡c, HÃ  Ná»i
                                                </a>
                                            </li>
                                            <li>
            ...
            <!-- otp js-->
            <script src="${pageContext.request.contextPath}/front-end/assets/js/otp.js"></script>
