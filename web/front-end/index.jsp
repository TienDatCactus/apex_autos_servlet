<li%@page contentType="text/html" pageEncoding="UTF-8" %>
    <%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        ...
        <body>
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-2">
                                                                    <div class="row">
                                                                        <div class="dropdown-column col-xl-3">
                                                                            <h5 class="dropdown-header">Daily Vegetables
                                                                            </h5>
                                                                            <a class="dropdown-item"
                                        ...
                                        <div class="home-detail p-center text-center home-overlay position-relative">
                                            <div>
                                                <div class="content ">
                                                    ...
                                                    <h3 class="text-light">Explore a wide selection of car models and
                                                        make your
                                                        purchase today</h3>
            ...
            <section class=" section-b-space pt-0">
                <ul class="d-flex justify-content-center pagination-lg">
                    <c:if test="${page.index != 0}">
                        ...
                        <li class="page-item">
                            <a href='${pageContext.request.contextPath}/home?index=${page.index -1}' class="page-link"
            ...
            <section class="newsletter-section section-b-space container">
                <!-- <div class="container-fluid-lg">
                    i
                    <div class="newsletter-box newsletter-box-2" style="
                    background-image: 
                    url('.assets/images/vegetable/banner/15.jpg')">
                                ...
                                <div class="row">
                                    <div class="col-xxl-4 col-lg-5 col-md-7 col-sm-9 offset-xxl-2 offset-md-1">
                                        <div class="newsletter-detail">
                                            ...
                                            <h5>5% discount for your first order</h5>
                                            <div class="input-box">
                                                <input type="email" class="form-control" id="exampleFormControlInput1"
                                                    placeholder="Enter Your Email">
                                                <i class="fa-solid fa-envelope arrow"></i>
                                                <button class="sub-btn button-83">
                ...
                <img src="./assets/images/vegetable/newsletter/1.png"
                    class="img-fluid lazyloaded blur-up rounded" alt="">
            </section>
                                ...
                                <div class="col-lg-6">
                                    <div class="right-sidebar-modal">
                                        ...
                                        <div class="product-detail">
                                            ...
                                            <p>Candy canes sugar plum tart cotton candy chupa chups sugar plum chocolate
                                                I love.
                ...
                <div class="modal-dialog modal-dialog-centered modal-fullscreen-sm-down">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <p class="mt-1 text-content">Enter your address and we will specify the offer for your area.
                            </p>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                                <i class="fa-solid fa-xmark"></i>
                            </button>
