...
<html lang="en">
    ...
    <head>
        ...
        <title>Quên mật khẩu - ApexCommerce</title>
                        ...
                        <div class="d-flex align-items-center justify-content-center h-100">
                            <div class="log-in-box ">
                                <div class="log-in-title">
                                    ...
                                    <h4>Gửi yêu cầu lên hệ thống qua Email : </h4>
                                </div>
                                ...
                                <div class="input-box">
                                    <form class="row g-4" id="form-1" action="mail?action=forgot" method="post">
                                        ...
                                        <div class="sign-up-box m-0 mt-1 ">
                                            <h4 class="lh-base">Bạn nhớ lại mật khẩu rồi à ?<br /> Quay lại <a href="login" style="display: inline">đăng nhập</a></h4>
                                        </div>
                                    </form>
                                </div>
                            </div>
