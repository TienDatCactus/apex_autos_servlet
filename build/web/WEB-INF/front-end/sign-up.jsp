              ...
              <div class="middle-box">
                <div class="location-box" style="background-color: #acacac;">
                  <button class="btn location-button" data-bs-toggle="modal" data-bs-target="#locationModal">
                    ...
                    <span class="locat-name" style="text-decoration: line-through;color: #5e5e5e;">Your Location</span>
              ...
              <form class="row g-2" id="form-1">
                <div class="col-12">
                  <div class="row g-2">
                    <div class="form-floating theme-form-floating col-6 input fname-input">
                      <input type="text" class="form-control input" id="fname" placeholder="Full Name" />
                      <label for="fname">First Name</label>
                      <span class="form-msg"></span>
                    </div>
                    <div class="form-floating theme-form-floating col-6 input lname-input">
                      <input type="text" class="form-control input " id="lname" placeholder="Full Name" />
                ...
                <div class="col-12">
                  <div class="form-floating theme-form-floating input phone-input">
                    <input type="text" class="form-control input" id="phone" placeholder="Phone" />
                ...
                <div class="col-12">
                  <button class="button-38 w-100 justify-content-center" onclick="location.href='otp.html'"
                    type="submit">
