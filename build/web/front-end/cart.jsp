                                            ...
                                            <div>
                                                <div class="timer-notification" style="overflow-x: hidden;">
                                                    <h6>
                                                        ...
                                                        new offers/gift every day on Weekends.<strong class="ms-1">New
                                                            Coupon
                                                            Code:
                                                            niggaWhat!
                                                        </strong>
                                            ...
                                            <div>
                                                <div class="timer-notification">
                                                    <h6>
                                                        ...
                                                        <a href="home" class="text-white">Buy Now !</a>
                                                    </h6>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <li class="right-nav-list">
                                            <div class="dropdown theme-form-select">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end sm-dropdown-menu"
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item" id="aud"
                                                            href="javascript:void(0)">VND</a>
                                                    </li>
                                                    <li>
                                                        <a class="dropdown-item" id="cny"
                                                    ...
                                                    <div class="onhover-category-box">
                                                        <div class="list-1">
                                                            ...
                                                            <ul>
                                                                ...
                                                                <li>
                                                                    <a href="javascript:void(0)">Cabbage &
                                                                        Cauliflower</a>
                                                                </li>
                                                                <li>
                                                        ...
                                                        <div class="list-2">
                                                            ...
                                                            <ul>
                                                                ...
                                                                <li>
                                                                    <a href="javascript:void(0)">Apples &
                                                                        Pomegranate</a>
                                                                </li>
                                                                <li>
                                                    ...
                                                    <div class="onhover-category-box w-100">
                                                        <div class="list-1">
                                                            ...
                                                            <ul>
                                                                ...
                                                                <li>
                                                                    <a href="javascript:void(0)">Sports & Energy
                                                                        Drinks</a>
                                                                </li>
                                                                <li>
                                                                    <a href="javascript:void(0)">Non Alcoholic
                                                                        Drinks</a>
                                                                </li>
                                                                <li>
                                                    ...
                                                    <div class="onhover-category-box">
                                                        ...
                                                        <div class="list-2">
                                                            ...
                                                            <ul>
                                                                ...
                                                                <li>
                                                                    <a href="javascript:void(0)">Frozen Fish &
                                                                        Seafood</a>
                                                                </li>
                                                                <li>
                                                    ...
                                                    <div class="onhover-category-box">
                                                        <div class="list-1">
                                                            ...
                                                            <ul>
                                                                ...
                                                                <li>
                                                                    <a href="javascript:void(0)">Granola & Cereal
                                                                        Bars</a>
                                                                </li>
                                                                <li>
                                                                ...
                                                                <li>
                                                                    <a href="javascript:void(0)">Frozen Non-Veg
                                                                        Snacks</a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                        ...
                                                        <div class="list-2">
                                                            ...
                                                            <ul>
                                                                ...
                                                                <li>
                                                                    <a href="javascript:void(0)">Paneer, Tofu &
                                                                        Cream</a>
                                                                </li>
                                                                <li>
                                                                ...
                                                                <li>
                                                                    <a href="javascript:void(0)">Condensed, Powdered
                                                                        Milk</a>
                                                                </li>
                                                                <li>
                                                                ...
                                                                <li>
                                                                    <a href="javascript:void(0)">Flavoured, Soya
                                                                        Milk</a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    ...
                                                    <div class="onhover-category-box">
                                                        <div class="list-1">
                                                            ...
                                                            <ul>
                                                                ...
                                                                <li>
                                                                    <a href="javascript:void(0)">Marie, Health,
                                                                        Digestive</a>
                                                                </li>
                                                                <li>
                                                                    <a href="javascript:void(0)">Cream Biscuits &
                                                                        Wafers</a>
                                                                </li>
                                                                <li>
                                                                    <a href="javascript:void(0)">Glucose & Milk
                                                                        Biscuits</a>
                                                                </li>
                                                                <li>
                                                        ...
                                                        <div class="list-2">
                                                            ...
                                                            <ul>
                                                                <li>
                                                                    <a href="javascript:void(0)">Bread Sticks &
                                                                        Lavash</a>
                                                                </li>
                                                                <li>
                                                                    <a href="javascript:void(0)">Cheese & Garlic
                                                                        Bread</a>
                                                                </li>
                                                                <li>
                                                                    <a href="javascript:void(0)">Puffs, Patties,
                                                                        Sandwiches</a>
                                                                </li>
                                                                <li>
                                                                    <a href="javascript:void(0)">Breadcrumbs &
                                                                        Croutons</a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                ...
                                                <li class="onhover-category-list">
                                                    ...
                                                    <div class="onhover-category-box">
                                                        <div class="list-1">
                                                            ...
                                                            <ul>
                                                                <li>
                                                                    <a href="javascript:void(0)">Lemon, Ginger &
                                                                        Garlic</a>
                                                                </li>
                                                                <li>
                                                                    <a href="javascript:void(0)">Indian & Exotic
                                                                        Herbs</a>
                                                                </li>
                                                                <li>
                                                        ...
                                                        <div class="list-2">
                                                            ...
                                                            <ul>
                                                                ...
                                                                <li>
                                                                    <a href="javascript:void(0)">Organic Dals &
                                                                        Pulses</a>
                                                                </li>
                                                                <li>
                                                                    <a href="javascript:void(0)">Organic Millet &
                                                                        Flours</a>
                                                                </li>
                                                                <li>
                                                                    <a href="javascript:void(0)">Organic Sugar,
                                                                        Jaggery</a>
                                                                </li>
                                                                <li>
                                                                    <a href="javascript:void(0)">Organic Masalas &
                                                                        Spices</a>
                                                                </li>
                                                                <li>
                                                                    <a href="javascript:void(0)">Organic Rice, Other
                                                                        Rice</a>
                                                                </li>
                                                                <li>
                                                                ...
                                                                <li>
                                                                    <a href="javascript:void(0)">Organic Edible Oil,
                                                                        Ghee</a>
                                                                </li>
                                                            </ul>
                                                        </div>
                            ...
                            <div class="row g-md-4 g-3">
                                <div class="col-xl-3 col-lg-4 col-sm-6">
                                    <div class="footer-logo">
                                        ...
                                        <div class="footer-logo-contain">
                                            <p>We are a friendly bar serving a variety of cocktails, wines and beers.
                                                Our bar is a
                                ...
                                <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6">
                                    ...
                                    <div class="footer-contain">
                                        <ul>
                                            <li>
                                                <a href="shop-left-sidebar.html" class="text-content">Vegetables &
                                                    Fruit</a>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                <a href="shop-left-sidebar.html" class="text-content">Meats &
                                                    Seafood</a>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                <a href="shop-left-sidebar.html" class="text-content">Biscuits &
                                                    Snacks</a>
                                            </li>
                                            <li>
                                                <a href="shop-left-sidebar.html" class="text-content">Grocery &
                                                    Staples</a>
                                            </li>
                                        </ul>
                                    </div>
