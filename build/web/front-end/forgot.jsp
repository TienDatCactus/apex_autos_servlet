                    ...
                    <div class="row">
                        <div class="col-xxl-6 col-xl-5 col-lg-6 d-lg-block d-none ms-auto">
                            <div class="image-contain">
                                <img src="${pageContext.request.contextPath}/front-end/assets/images/inner-page/forgot.png" class="img-fluid" alt="">
                            </div>
                        </div>
                                ...
                                <div class="log-in-box">
                                    ...
                                    <div class="input-box">
                                        <form class="row g-4" id="form-1" action="mail?action=forgot" method="post">
                                            ...
                                            <div class="sign-up-box m-0 ">
                                                <h4 class="lh-base">Just remember your password ?<br /> Get back to</h4>
                                                <a href="login">Log In</a>
                                            </div>
                                        </form>
                                    </div>
