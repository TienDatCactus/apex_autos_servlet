...
<html lang="en">
    ...
    <body>
        ...
        <!-- Compare Section Start -->
            ...
            <section type="hidden" class="compare-section section-b-space">
                <div class="container-fluid-lg">
                    <div class="row">
                        <div class="col-12">
                            <c:if test="${compareItems.size() > 0}">
                                ...
                                <table class="table compare-table">
                                    <tbody>
                                        ...
                                        <tr>
                                            <th>weight</th>
                                                  <c:forEach var="ci" items="${compareItems}">
                                                <td>${ci.weight}</td></c:forEach>

                                            </tr>
                                            <tr>
                                                <th>acceleration</th>
                                                  <c:forEach var="ci" items="${compareItems}">
                                                <td>${ci.acceleration}</td></c:forEach>

                                            </tr>
                                            <tr>
                                                <th>Year</th>
                                                 <c:forEach var="ci" items="${compareItems}">
                                                <td>${ci.model_year}</td></c:forEach>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                        ...
                                                        <form id="form-cart-${ci.car_id}"
                                                              action="cart?action=addtocart&id_car=${ci.car_id}"
                                                              method="post">
                                                            <button type="submit" class="btn btn-animation btn-sm w-100">Add To Cart</button>
                                        ...
                                        <tr>
                                            <th></th>
                                                ...
                                                <td>
                                                    ...
                                                    <!--<a href="javascript:void(00" class="text-content remove_column">-->
                                                    <button type="submit">
                                                        <i class="fa-solid fa-trash-can me-2"></i> Remove</button>
                                                    <!--</a>-->
                                                        </form>
                                                </td>
                                            </c:forEach>
